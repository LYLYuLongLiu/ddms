...
<body>
	<div style="padding: 15px;">
		<form class="layui-form" action="">
			<c:forEach items="${clazzresult}" var="clazz">
			<input type="hidden" id="id" value="${clazz.id}"></input>
			<div class="layui-form-item">
				<div class="layui-inline">
					<label class="layui-form-label">班级名称</label>
					<div class="layui-input-inline">
						<input type="text" name="clazzname" id="clazzName" autocomplete="off"
							class="layui-input" value="${clazz.clazzName}">
					</div>
				</div>
				</div>
				<div class="layui-form-item">
					<div class="layui-inline">
						...
						<div class="layui-input-inline">
							<input type="text" name="clazzNum" id="clazzNum" autocomplete="off"
								   class="layui-input" value="${clazz.clazzNum}">
						</div>
					</div>
				</div>
				<div class="layui-form-item">
				...
				<%--<div class="layui-inline">--%>
					...
					<%--<div class="layui-input-inline">--%>
						<%--<input type="text" name="remark"--%>
							...
							<%--class="layui-input" value="${clazz.remark}">--%>
					<%--</div>--%>
				<%--</div>--%>
...
layui.use(['form', 'layedit', 'laydate'], function(){
	  ...
	  form.on('submit(demo1)', function(data){
	    //layer.alert(JSON.stringify(data.field), {
	     // title: '最终的提交信息'
	   // })
	   console.log($('#clazzName').val());
	   	$.ajax({
	   		url:'http://localhost:8080/clazz/update',
	   		type:"post",
	   		data:{
	   			id:$('#id').val(),
	   			clazzName : $('#clazzName').val(),
				clazzNum : $('#clazzNum').val(),
