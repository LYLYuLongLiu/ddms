...
<div class="x-body">
    <form class="layui-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="L_crLocation" value="${ clazzRoom.crLocation }" name="crLocation" required=""
                       autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="L_crMaxstunum" value="${ clazzRoom.crMaxstunum }" name="crMaxstunum" required=""
                       autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
...
<script src="/js/clazzroom/clazzroom_edit.js"></script>
